...
class PRIntegration:
    ...
    def generate_pr_summary(result: AnalysisResult) -> str:
        ...
        lines.append("## 📊 Refactron Analysis Summary")
        lines.append("")
        ...
        lines.append(f"| ⚠️ Error Issues | {summary['errors']} |")
        lines.append(f"| 💡 Warning Issues | {summary['warnings']} |")
        lines.append(f"| 📝 Info Issues | {summary['info']} |")
        ...
        if summary["files_failed"] > 0:
            lines.append(f"❌ **{summary['files_failed']} file(s) failed analysis**")
            lines.append("")

        # Top issues by file
        if result.all_issues:
            lines.append("### 🔍 Top Issues by File")
            lines.append("")
