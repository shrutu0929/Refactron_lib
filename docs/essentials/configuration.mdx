...
<AccordionGroup>
  ...
  <Accordion icon="bolt" title="performance">
    Detects runtime performance antipatterns: N+1 queries, inefficient list operations, unnecessary iterations, inefficient string concatenation, and redundant `list()` calls
  </Accordion>
...
<AccordionGroup>
  <Accordion title="extract_method">
